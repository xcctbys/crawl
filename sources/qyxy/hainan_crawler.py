...
class HainanCrawler(object):
    ...
    def crawl_ent_pub_pages(self, url, post_data={}):
        sub_json_dict = {}
        try:
            page = self.crawl_page_by_url_post(urls['host'] + "/BusinessAnnals/BusinessAnnalsList.html",
                                               post_data)['page']
            ...
            page = self.crawl_page_by_url_post(urls['host'] + "/GDGQTransferMsg/shareholderTransferMsg.html",
                                               post_data)['page']
    ...
    def crawl_other_dept_pub_pages(self, url, post_data={}):
        sub_json_dict = {}
        try:
            page = self.crawl_page_by_url_post(urls['host'] + "/OtherPublicity/environmentalProtection.html",
                                               post_data)['page']
    ...
    def crawl_judical_assist_pub_pages(self, url, post_data={}):
        sub_json_dict = {}
        try:
            page = self.crawl_page_by_url_post(urls['host'] + "/judiciaryAssist/judiciaryAssistInit.html",
                                               post_data)['page']
