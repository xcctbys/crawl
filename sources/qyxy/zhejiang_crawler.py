...
class ZhejiangCrawler(object):
        ...
        try:
            ...
            for i, l in enumerate(lists):
                if int(l['intelTypeSelect']) == 1:
                    ...
                    url = urls['host'] + "/pubinstantintellectual/doEnPubIntel.do?pubInstantIntellectual.intelNo=" + l[
                        'intelNo']
    ...
    def parse_page_xzxk(self, page="", div_id=""):
        ...
        try:
            ...
            for i, l in enumerate(lists):
                if int(l['licType']) == 1:
                    url = urls['host'] + '/publicense/doReadDetail.do?pubLicense.licNo=' + str(l[
    ...
    def parse_table_modHis(self, table):
        ...
        table_data = []
        try:
            url = urls['host'] + "/pubreportmodhis/doReadPubReportModHisJSON.do?_id=" + "doReadPubReportModHis" + str(
                int(time.time()))
            data = {
