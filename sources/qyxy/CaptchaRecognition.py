...
class CaptchaRecognition(object):
    ...
    def __init__(self, captcha_type="beijing"):
        ...
        if captcha_type not in ["jiangsu", "beijing", "zongju", "liaoning", "guangdong", "hubei", "tianjin", "qinghai",
                                "shanxi", "henan", "guangxi", "xizang", "heilongjiang", "anhui", "shaanxi", "ningxia",
            ...
            self.masker = 255
                              ...
                              "guangxi", "xizang", "heilongjiang", "anhui", "shaanxi", "ningxia", "chongqing",
                              "sichuan", "hunan", "gansu", "xinjiang", "guizhou", "shandong", "hebei", "neimenggu",
                              "zhejiang", "jilin", "yunnan", "fujian", "hebei"]:
            self.to_denoise = True
            self.masker = 255
