...
special_parse_keys = ("ent_pub_ent_annual_report", "ind_comm_pub_reg_shareholder", "ent_pub_administration_license", )
...
type_date = ("check_date", "subscription_date", "paid_date", "modify_date", "sharechange_register_date",
             "penalty_publicit_date", "penalty_decision_date", "list_on_date", "list_out_date",
             "sharechange_publicity_date", "share_change_date", "license_end_date", "license_begin_date",
             "mortgage_register_date", "decision_date", "time_start", "time_end", "publicity_time",
             "license_publicity_time", "publicity_date", "paid_time", "subscription_time", "license_register_time",
             "license_change_time")
