...
class GansuClawer(Crawler):
    ...
    def crawl_check_page(self):
        ...
        while count < 30:
            ...
            data = {'browse': '',
                    'loginName': '输入注册号/统一代码点击搜索',
                    'cerNo': '',
                    'authCode': '',
                    'authCodeQuery': ck_code,
    ...
    def crawl_page_by_post_data(self, data, name='detail.html', url=None):
        ...
        if resp.status_code != 200:
            settings.logger.error('crawl page by url failed! url = %s' % GansuClawer.urls['post_all_page'])
        page = resp.content
    ...
    def parse_ent_pub_knowledge_property_pages(self, page):
        ...
        if len(knowledge_property_trs) > 2:
            ...
            while i < len(knowledge_property_trs):
                ...
                detail_knowledge_property_info[u'变化情况'] = self.wipe_off_newline_and_blank_for_fe(tds[8].get_text())
