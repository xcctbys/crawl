...
class TestMongodb(TestCase):
	...
	def test_insert_enterprise_job(self):
		...
		ct1.save()
		ct1 = CrawlerTask(job=job1, task_generator=ctg1, uri='enterprise://云南/大理富民兴业股权投资基金管理有限公司/532910100007315/', args='i', from_host='1')
		ct1.save()
		ct1 = CrawlerTask(job=job1, task_generator=ctg1, uri='enterprise://北京/北京众润投资基金管理有限公司/110105018837481/', args='i', from_host='1')
		ct1.save()
		ct1 = CrawlerTask(job=job1, task_generator=ctg1, uri='enterprise://广东/深圳市郞润承泽资产管理有限公司/440301113021601/', args='i', from_host='1')
		ct1.save()
		ct1 = CrawlerTask(job=job1, task_generator=ctg1, uri='enterprise://广东/金匙资本管理（深圳）有限公司/440301113278486/', args='i', from_host='1')
		ct1.save()
		ct1 = CrawlerTask(job=job1, task_generator=ctg1, uri='enterprise://江苏/江苏银凤金革资产管理有限公司/320106000236597/', args='i', from_host='1')
		ct1.save()
		ct1 = CrawlerTask(job=job1, task_generator=ctg1, uri='enterprise://北京/中安富海投资管理有限公司/110105010701073/', args='i', from_host='1')
		ct1.save()
		ct1 = CrawlerTask(job=job1, task_generator=ctg1, uri='enterprise://广东/深圳润阁投资管理有限公司/440301111930453/', args='i', from_host='1')
		ct1.save()
		ct1 = CrawlerTask(job=job1, task_generator=ctg1, uri='enterprise://广东/深圳市金汇隆投资管理有限公司/440301109991545/', args='i', from_host='1')
		ct1.save()
		ct1 = CrawlerTask(job=job1, task_generator=ctg1, uri='enterprise://山东/山东正融资产管理有限公司/371300200058462/', args='i', from_host='1')
		ct1.save()
		# codestr2 = open('/Users/princetechs3/my_code/code2.sh','r').read()
		cd1 =CrawlerDownload(job=job1, code='codestr2', types=onetype)
		cd1.save()
