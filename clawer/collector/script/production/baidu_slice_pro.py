...
try:
    REDIS = "redis://:Password123@13153c2b13894978.m.cnsza.kvstore.aliyuncs.com/1"
...
REDIS_TABLE = 'baidu_company_search_<SLICE>'
...
class Generator(object):
    ...
    def __init__(self):
        ...
        self.history.load()
        # self.source_url = "http://clawer.princetechs.com/enterprise/api/get/all/"    # Enterprise Data API
        self.enterprises= []
        self.step = STEP
