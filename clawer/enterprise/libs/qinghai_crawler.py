...
class QinghaiCrawler(HeilongjiangClawer):
    ...
    urls = {'host': 'http://218.95.241.36',
            ...
            'http://218.95.241.36/businessPublicity.jspx?id=',
            'ent_pub_skeleton':
            'http://218.95.241.36/enterprisePublicity.jspx?id=',
            'other_dept_pub_skeleton':
            'http://218.95.241.36/otherDepartment.jspx?id=',
            'judical_assist_skeleton':
            'http://218.95.241.36/justiceAssistance.jspx?id=',
            'ind_comm_pub_reg_shareholder':
            'http://218.95.241.36/QueryInvList.jspx?',    # 股东信息
            'ind_comm_pub_reg_modify':
            'http://218.95.241.36/QueryAltList.jspx?',    # 变更信息翻页
            'ind_comm_pub_arch_key_persons':
            'http://218.95.241.36/QueryMemList.jspx?',    # 主要人员信息翻页
            'ind_comm_pub_spot_check':
            'http://218.95.241.36/QuerySpotCheckList.jspx?',    # 抽样检查信息翻页
            'ind_comm_pub_movable_property_reg':
            'http://218.95.241.36/QueryMortList.jspx?',    # 动产抵押登记信息翻页
            'ind_comm_pub_business_exception':
            'http://218.95.241.36/QueryExcList.jspx?',    # 经营异常信息
            'ent_pub_administration_license':
            'http://218.95.241.36/QueryLicenseRegList.jspx?',    # 行政许可信息
            'shareholder_detail':
            'http://218.95.241.36/queryInvDetailAction.jspx?id=',    # 投资人详情
            'movable_property_reg_detail':
            'http://218.95.241.36/mortInfoDetail.jspx?id=',    # 动产抵押登记详情
            'annual_report':
