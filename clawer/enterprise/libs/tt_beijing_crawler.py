...
class CrackCheckcode(object):
    ...
    def crawl_check_page(self):
        ...
        while count < 15:
            ...
            post_data = {'currentTimeMillis': self.info.time_stamp,
                         'credit_ticket': self.info.credit_ticket,
                         'checkcode': ckcode[1],
                         'keyword': self.info.ent_number}
...
class MyParser(Parser):
    ...
    def parse_post_check_page(self, page):
        ...
        r = BeautifulSoup(self.info.after_crack_checkcode_page, 'html.parser').find_all('input',
                                                                                        {'type': "hidden",
...
class IndustrialPubliction(object):
    ...
    def get_registration_info(self, *args, **kwargs):
        param = {'entId': self.info.ent_id,
                 'credit_ticket': self.info.credit_ticket,
                 'entNo': self.info.ent_number,
                 'timeStamp': self.info.time_stamp}
        resp = self.crawler.crawl_page_by_url(self.info.urls['ind_comm_pub_reg_basic'], params=param)
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_reg_basic',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        # print content
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_reg_shareholder',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        # print content
        ths, tds = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_reg_modify',
                                                           content=content,
                                                           element='table',
                                                           attrs={'cellspacing': "0",
                                                                  'cellpadding': "0",
        ...
        for i, td in enumerate(tds):
            if isinstance(td, basestring) and td.find('show') == 0:
                ...
                # print tables[0]
                # print tables[1]
                tds[i] = self.parser.parser_classic_ths_tds_data_for_ind_comm_pub(what='parser_ind_comm_pub_reg_modify',
                                                                                  content=tables[0],
                                                                                  element='table')
                # print tds[i]
    ...
    def get_record_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        # print content
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_arch_key_persons',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        # print content
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_arch_branch',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        # print content
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_arch_liquidation',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_movable_property_registration_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_movable_property_reg',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_stock_equity_pledge_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_equity_ownership_reg',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_administrative_penalty_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_administration_sanction',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_abnormal_operation_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_business_exception',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_serious_illegal_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_serious_violate_law',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_spot_check_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ind_comm_pub_spot_check',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
...
class EnterprisePubliction(object):
    ...
    def get_corporate_annual_reports_info(self, *args, **kwargs):
        ...
        # print content
        ths, tds = self.parser.parser_ent_pub_ent_annual_report(what='parser_ent_pub_ent_annual_report',
                                                                content=content,
                                                                element='table',
                                                                attrs={'cellspacing': "0",
                                                                       'cellpadding': "0"})
        ...
        for i, td in enumerate(tds):
            if td.find('qynb') != -1:
                ...
                # print content
                temp = {}
                temp[u'企业基本信息'] = self.parser.parser_ent_pub_ent_annual_report_for_detail(what='basic',
                                                                                          content=content[0])
                ...
                content = BeautifulSoup(resp.content, 'html.parser').find_all('table')
                # print content
                temp[u'对外提供保证担保信息'] = self.parser.parser_ent_pub_ent_annual_report_for_detail(what='',
                                                                                              content=content[0])
    ...
    def get_shareholder_contribution_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ent_pub_shareholder_capital_contribution',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_equity_change_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ent_pub_equity_change',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_administrative_licensing_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ent_pub_administration_license',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_intellectual_property_rights_pledge_registration_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ent_pub_knowledge_property',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_administrative_punishment_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='ent_pub_administration_sanction',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
...
class OtherDepartmentsPubliction(object):
    ...
    def get_administrative_licensing_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='other_dept_pub_administration_license',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
    ...
    def get_administrative_punishment_info(self, *args, **kwargs):
        ...
        content = BeautifulSoup(resp.content, 'html.parser')
        result = self.parser.parser_classic_ths_tds_data(what='other_dept_pub_administration_sanction',
                                                         content=content,
                                                         element='table',
                                                         attrs={'cellspacing': "0",
                                                                'cellpadding': "0",
