...
db_total_dict = dict([('10', set()), ('11', set()), ('12', set()), ('13', set()), ('14', set()), ('15', set(
)), ('21', set()), ('22', set()), ('23', set()), ('30', set()), ('31', set()), ('32', set()), ('33', set()), ('34', set(
)), ('35', set()), ('36', set()), ('37', set()), ('41', set()), ('42', set()), ('43', set()), ('44', set()), ('45', set(
)), ('46', set()), ('49', set()), ('50', set()), ('51', set()), ('52', set()), ('53', set()), ('54', set()), ('61', set(
)), ('62', set()), ('63', set()), ('64', set()), ('65', set()), ('71', set()), ('81', set()), ('82', set()), ('40', set(
))])

success_dict = dict([('10', set()), ('11', set()), ('12', set()), ('13', set()), ('14', set()), ('15', set(
)), ('21', set()), ('22', set()), ('23', set()), ('31', set()), ('32', set()), ('33', set()), ('34', set()), ('35', set(
)), ('36', set()), ('37', set()), ('41', set()), ('42', set()), ('43', set()), ('44', set()), ('45', set()), ('46', set(
)), ('50', set()), ('51', set()), ('52', set()), ('53', set()), ('54', set()), ('61', set()), ('62', set()), ('63', set(
)), ('64', set()), ('65', set()), ('71', set()), ('81', set()), ('82', set()), ('30', set()), ('49', set()), ('40', set(
))])

fail_dict = dict([('10', set()), ('11', set()), ('12', set()), ('13', set()), ('14', set()), ('15', set()), ('21', set(
)), ('22', set()), ('23', set()), ('31', set()), ('32', set()), ('33', set()), ('34', set()), ('35', set()), ('36', set(
)), ('37', set()), ('41', set()), ('42', set()), ('43', set()), ('44', set()), ('45', set()), ('46', set()), ('50', set(
)), ('51', set()), ('52', set()), ('53', set()), ('54', set()), ('61', set()), ('62', set()), ('63', set()), ('64', set(
)), ('65', set()), ('71', set()), ('81', set()), ('82', set()), ('30', set()), ('49', set()), ('40', set())])

db_down_dict = dict([('10', set()), ('11', set()), ('12', set()), ('13', set()), ('14', set()), ('15', set(
)), ('21', set()), ('22', set()), ('23', set()), ('31', set()), ('32', set()), ('33', set()), ('34', set()), ('35', set(
)), ('36', set()), ('37', set()), ('41', set()), ('42', set()), ('43', set()), ('44', set()), ('45', set()), ('46', set(
)), ('50', set()), ('51', set()), ('52', set()), ('53', set()), ('54', set()), ('61', set()), ('62', set()), ('63', set(
)), ('64', set()), ('65', set()), ('71', set()), ('81', set()), ('82', set()), ('30', set()), ('49', set()), ('40', set(
...
db_update_dict = dict([('10', set()), ('11', set()), ('12', set()), ('13', set()), ('14', set()), ('15', set(
)), ('21', set()), ('22', set()), ('23', set()), ('31', set()), ('32', set()), ('33', set()), ('34', set()), ('35', set(
)), ('36', set()), ('37', set()), ('41', set()), ('42', set()), ('43', set()), ('44', set()), ('45', set()), ('46', set(
)), ('50', set()), ('51', set()), ('52', set()), ('53', set()), ('54', set()), ('61', set()), ('62', set()), ('63', set(
)), ('64', set()), ('65', set()), ('71', set()), ('81', set()), ('82', set()), ('30', set()), ('49', set()), ('40', set(
...
db_except_dict = dict([('10', set()), ('11', set()), ('12', set()), ('13', set()), ('14', set()), ('15', set(
)), ('21', set()), ('22', set()), ('23', set()), ('31', set()), ('32', set()), ('33', set()), ('34', set()), ('35', set(
)), ('36', set()), ('37', set()), ('41', set()), ('42', set()), ('43', set()), ('44', set()), ('45', set()), ('46', set(
)), ('50', set()), ('51', set()), ('52', set()), ('53', set()), ('54', set()), ('61', set()), ('62', set()), ('63', set(
)), ('64', set()), ('65', set()), ('71', set()), ('81', set()), ('82', set()), ('30', set()), ('49', set()), ('40', set(
...
def alanysis_data(count_except, count_clawer):
    ...
    reportfile.write(
        '%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s' %
        (u'代号', u'省份', u'总共', u'爬取非空', u'爬取为空', u'共爬取', u'爬取异常', u'未爬取', u'爬取率', u'入库数', u'未入库', u'入库率', u'库存量', u'缺少量',
         u'成功率', u'爬取为非空并入库', u'爬取并入库'))
    reportfile.write('\n')
    for key, value in db_total_dict.items():
        ...
        total_not_clawer_num += (len(db_total_dict[key]) -
                                 len(success_dict[key])) - len(fail_dict[key]) - len(db_except_dict[key])
    ...
    reportfile.write('\n')
    reportfile.write(
        '%-15s,%-15s,%-15s,%-15s,%-15s,%s(%s),%s(%s),%s(%s),%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s,%-15s' %
        (u'总计', len(db_total_dict.keys()), total_enterprise_num, total_clawer_not_none, total_clawer_is_none,
         total_clawer_num, count_clawer, total_clawer_except_num, count_except, total_not_clawer_num,
         total_enterprise_num - count_clawer - count_except, u'未', total_update_db_num, total_not_update_db_num, u'未',
         total_come_in_db_num, total_not_come_in_db_num, u'未', total_clawer_not_none_and_come_in_db_num,
