...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(name='Basic',
                               fields=[
                                   ('id', models.AutoField(verbose_name='ID',
                                                           serialize=False,
                                                           auto_created=True,
                                                           primary_key=True)),
                                   ('credit_code', models.CharField(max_length=50,
                                                                    null=True,
                                                                    blank=True)),
        ...
        migrations.CreateModel(name='EnterAdministrativeLicense',
                               fields=[
                                   ...
                                   ('license_authority', models.CharField(max_length=30,
                                                                          null=True,
                                                                          blank=True)),
                                   ('license_content', models.TextField(null=True,
                                                                        blank=True)),
                                   ('license_status', models.TextField(null=True,
                                                                       blank=True)),
                                   ('license_detail', models.TextField(null=True,
                                                                       blank=True)),
                                   ('license_register_time', models.DateField(null=True)),
                                   ('license_publicity_time', models.DateField(null=True)),
                                   ('license_change_item', models.CharField(max_length=20,
                                                                            null=True,
                                                                            blank=True)),
                                   ('license_change_time', models.DateField(null=True)),
                                   ('license_content_before', models.CharField(max_length=50,
                                                                               null=True,
                                                                               blank=True)),
                                   ('license_content_after', models.CharField(max_length=50,
                                                                              null=True,
                                                                              blank=True)),
        ...
        migrations.CreateModel(name='EnterAdministrativePenalty',
                               fields=[
                                   ('id', models.AutoField(verbose_name='ID',
                                                           ...
                                                           auto_created=True,
                                                           primary_key=True)),
                                   ('penalty_decision_num', models.CharField(max_length=30,
                                                                             null=True,
                                                                             blank=True)),
                                   ('illegal_type', models.CharField(max_length=100,
                                                                     null=True,
                                                                     blank=True)),
                                   ('administrative_penalty_content', models.CharField(max_length=30,
                                                                                       null=True,
                                                                                       blank=True)),
                                   ...
                                   ('penalty_comment', models.CharField(max_length=1024,
                                                                        null=True,
                                                                        blank=True)),
        ...
        migrations.CreateModel(name='EnterIntellectualPropertyPledge',
                               fields=[
                                   ...
                                   ('property_type', models.CharField(max_length=30,
                                                                      null=True,
                                                                      blank=True)),
                                   ('pledgor_name', models.CharField(max_length=30,
                                                                     null=True,
                                                                     blank=True)),
                                   ...
                                   ('property_status', models.CharField(max_length=40,
                                                                        null=True,
                                                                        blank=True)),
                                   ('property_pledge_change', models.CharField(max_length=40,
                                                                               null=True,
                                                                               blank=True)),
                                   ('property_pledge_register_gov', models.CharField(max_length=30,
                                                                                     null=True,
                                                                                     blank=True)),
        ...
        migrations.CreateModel(name='EnterModification',
                               fields=[
                                   ('id', models.AutoField(verbose_name='ID',
                                                           ...
                                                           auto_created=True,
                                                           primary_key=True)),
                                   ('modify_item', models.TextField(null=True,
                                                                    blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.IntegerField(choices=[(1, '\u5b89\u5fbd'), (2, '\u5317\u4eac'), (
                    3, '\u91cd\u5e86'), (4, '\u798f\u5efa'), (5, '\u7518\u8083'), (6, '\u5e7f\u4e1c'), (
                        7, '\u5e7f\u897f'), (8, '\u8d35\u5dde'), (9, '\u6d77\u5357'), (10, '\u6cb3\u5317'), (
                            11, '\u9ed1\u9f99\u6c5f'), (12, '\u6cb3\u5357'), (13, '\u6e56\u5317'), (
                                14, '\u6e56\u5357'), (15, '\u6c5f\u82cf'), (16, '\u6c5f\u897f'), (17, '\u5409\u6797'), (
                                    18, '\u8fbd\u5b81'), (19, '\u5185\u8499\u53e4'), (20, '\u5b81\u590f'), (
                                        21, '\u9752\u6d77'), (22, '\u9655\u897f'), (23, '\u5c71\u4e1c'), (
                                            24, '\u4e0a\u6d77'), (25, '\u5c71\u897f'), (26, '\u56db\u5ddd'), (
                                                27, '\u5929\u6d25'), (28, '\u65b0\u7586'), (29, '\u4e91\u5357'), (
        ...
        migrations.CreateModel(name='EnterShareholder',
                               fields=[
                                   ...
                                   ('paid_type', models.CharField(max_length=100,
                                                                  null=True,
                                                                  blank=True)),
                                   ...
                                   ('detals', models.CharField(max_length=256,
                                                               null=True,
                                                               blank=True)),
                                   ('enter_id', models.CharField(max_length=20,
                                                                 null=True,
        ...
        migrations.CreateModel(name='IndustryCommerceAdminiPenalty',
                               fields=[
                                   ...
                                   ('illegal_type', models.CharField(max_length=100,
                                                                     null=True,
                                                                     blank=True)),
                                   ('penalty_content', models.CharField(max_length=1024,
                                                                        null=True,
                                                                        blank=True)),
        ...
        migrations.CreateModel(name='IndustryCommerceBranch',
                               fields=[
                                   ('id', models.AutoField(verbose_name='ID',
                                                           ...
                                                           auto_created=True,
                                                           primary_key=True)),
                                   ('enter_code', models.CharField(max_length=100,
                                                                   null=True,
                                                                   blank=True)),
        ...
        migrations.CreateModel(name='IndustryCommerceChange',
                               fields=[
                                   ...
                                   ('modify_item', models.TextField(null=True,
                                                                    blank=True)),
                                   ('modify_before', models.TextField(null=True,
                                                                      blank=True)),
                                   ('modify_after', models.TextField(max_length=50,
                                                                     null=True,
                                                                     blank=True)),
                                   ('modify_date', models.DateField(null=True)),
                                   ('enter_id', models.CharField(max_length=20,
        ...
        migrations.CreateModel(name='JudicialShareFreeze',
                               fields=[
                                   ('id', models.AutoField(verbose_name='ID',
                                                           ...
                                                           auto_created=True,
                                                           primary_key=True)),
                                   ('been_excute_person', models.CharField(max_length=30,
                                                                           null=True,
                                                                           blank=True)),
                                   ('share_num', models.IntegerField(null=True)),
                                   ('excute_court', models.CharField(max_length=30,
                                                                     null=True,
                                                                     blank=True)),
                                   ...
                                   ('freeze_status', models.CharField(max_length=30,
                                                                      null=True,
                                                                      blank=True)),
                                   ('freeze_detail', models.TextField(null=True,
                                                                      blank=True)),
                                   ('enter_id', models.CharField(max_length=20,
                                                                 null=True,
                                                                 blank=True)),
        ...
        migrations.CreateModel(name='OtherAdministrativeChange',
                               fields=[
                                   ('id', models.AutoField(verbose_name='ID',
                                                           ...
                                                           auto_created=True,
                                                           primary_key=True)),
                                   ('administrative_change_item', models.CharField(max_length=30,
                                                                                   null=True,
                                                                                   blank=True)),
                                   ('administrative_change_tme', models.DateField(null=True)),
                                   ('administrative_change_before', models.CharField(max_length=50,
                                                                                     null=True,
                                                                                     blank=True)),
                                   ('administrative_change_after', models.CharField(max_length=50,
                                                                                    null=True,
                                                                                    blank=True)),
                                   ('enter_id', models.CharField(max_length=20,
                                                                 null=True,
        ...
        migrations.CreateModel(name='OtherAdministrativeLicense',
                               fields=[
                                   ...
                                   ('license_content', models.TextField(null=True,
                                                                        blank=True)),
                                   ('license_authority_gov', models.CharField(max_length=50,
                                                                              null=True,
                                                                              blank=True)),
                                   ('license_status', models.TextField(null=True,
                                                                       blank=True)),
        ...
        migrations.CreateModel(name='YearReportBasic',
                               fields=[
                                   ('id', models.AutoField(verbose_name='ID',
                                                           serialize=False,
                                                           auto_created=True,
                                   ...
                                   ('enter_name', models.CharField(max_length=50,
                                                                   null=True,
                                                                   blank=True)),
                                   ('enter_phone', models.CharField(max_length=50,
                                                                    null=True,
                                                                    blank=True)),
                                   ('zipcode', models.CharField(max_length=30,
                                                                null=True,
                                                                blank=True)),
                                   ('enter_place', models.CharField(max_length=100,
                                                                    null=True,
                                                                    blank=True)),
                                   ...
                                   ('register_num', models.CharField(max_length=50,
                                                                     null=True,
                                                                     blank=True)),
                                   ('is_warrandice', models.CharField(max_length=10,
                                                                      null=True,
                                                                      blank=True)),
        ...
        migrations.CreateModel(name='YearReportCorrect',
                               fields=[
                                   ('id', models.AutoField(verbose_name='ID',
                                                           ...
                                                           auto_created=True,
                                                           primary_key=True)),
                                   ('correct_item', models.CharField(max_length=30,
                                                                     null=True,
                                                                     blank=True)),
        ...
        migrations.CreateModel(name='YearReportInvestment',
                               fields=[
                                   ('id', models.AutoField(verbose_name='ID',
                                                           ...
                                                           auto_created=True,
                                                           primary_key=True)),
                                   ('invest_enter_name', models.CharField(max_length=50,
                                                                          null=True,
                                                                          blank=True)),
                                   ('enter_code', models.CharField(max_length=100,
                                                                   null=True,
        ...
        migrations.CreateModel(name='YearReportOnline',
                               fields=[
                                   ...
                                   ('enter_name', models.CharField(max_length=50,
                                                                   null=True,
                                                                   blank=True)),
                                   ('enter_url', models.TextField(null=True,
                                                                  blank=True)),
                                   ('year_report_id', models.CharField(max_length=20,
                                                                       null=True,
                                                                       blank=True)),
        ...
        migrations.CreateModel(name='YearReportWarrandice',
                               fields=[
                                   ...
                                   ('debtor', models.CharField(max_length=30,
                                                               null=True,
                                                               blank=True)),
                                   ('main_creditor_right', models.CharField(max_length=30,
                                                                            null=True,
                                                                            blank=True)),
                                   ('main_creditor_right_amount', models.FloatField(null=True)),
                                   ('fullfill_debt_duration', models.CharField(max_length=100,
                                                                               null=True,
                                                                               blank=True)),
                                   ('guarantee_duration', models.CharField(max_length=30,
                                                                           null=True,
                                                                           blank=True)),
                                   ('guarantee_type', models.CharField(max_length=30,
                                                                       null=True,
                                                                       blank=True)),
                                   ('warrandice_scope', models.CharField(max_length=100,
                                                                         null=True,
                                                                         blank=True)),
                                   ('year_report_id', models.CharField(max_length=20,
                                                                       null=True,
