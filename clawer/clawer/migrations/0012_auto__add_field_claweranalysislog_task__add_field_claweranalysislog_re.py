...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClawerAnalysisLog.task'
        db.add_column('clawer_claweranalysislog', 'task',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['clawer.ClawerTask']),
                      keep_default=False)

        # Adding field 'ClawerAnalysisLog.result'
        db.add_column('clawer_claweranalysislog', 'result',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClawerAnalysisLog.task'
        db.delete_column('clawer_claweranalysislog', 'task_id')

        # Deleting field 'ClawerAnalysisLog.result'
        db.delete_column('clawer_claweranalysislog', 'result')
