...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClawerTask.clawer_generator'
        db.delete_column('clawer_clawertask', 'clawer_generator_id')

        # Adding field 'ClawerTask.task_generator'
        db.add_column('clawer_clawertask', 'task_generator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['clawer.ClawerTaskGenerator']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ClawerTask.clawer_generator'
        db.add_column('clawer_clawertask', 'clawer_generator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['clawer.ClawerTaskGenerator']),
                      keep_default=False)

        # Deleting field 'ClawerTask.task_generator'
        db.delete_column('clawer_clawertask', 'task_generator_id')
