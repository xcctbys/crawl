...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClawerGenerateLog'
        db.create_table('clawer_clawergeneratelog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('clawer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clawer.Clawer'])),
            ('task_generator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clawer.ClawerTaskGenerator'])),
            ...
            ('spend_msecs', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('add_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('clawer', ['ClawerGenerateLog'])

        # Deleting field 'ClawerTaskGenerator.last_failed_datetime'
        db.delete_column('clawer_clawertaskgenerator', 'last_failed_datetime')

        # Deleting field 'ClawerTaskGenerator.failed_reason'
        db.delete_column('clawer_clawertaskgenerator', 'failed_reason')


    def backwards(self, orm):
        # Deleting model 'ClawerGenerateLog'
        db.delete_table('clawer_clawergeneratelog')

        # Adding field 'ClawerTaskGenerator.last_failed_datetime'
        db.add_column('clawer_clawertaskgenerator', 'last_failed_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClawerTaskGenerator.failed_reason'
        db.add_column('clawer_clawertaskgenerator', 'failed_reason',
