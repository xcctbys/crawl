...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Logger'
        db.create_table('clawer_logger', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('from_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('add_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('clawer', ['Logger'])


    def backwards(self, orm):
        # Deleting model 'Logger'
        db.delete_table('clawer_logger')
