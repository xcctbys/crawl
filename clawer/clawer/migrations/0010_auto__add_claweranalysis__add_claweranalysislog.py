...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClawerAnalysis'
        db.create_table('clawer_claweranalysis', (
        ...
        db.send_create_signal('clawer', ['ClawerAnalysis'])

        # Adding model 'ClawerAnalysisLog'
        db.create_table('clawer_claweranalysislog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('clawer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clawer.Clawer'])),
            ('analysis', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clawer.ClawerAnalysis'])),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('add_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('clawer', ['ClawerAnalysisLog'])


    def backwards(self, orm):
        # Deleting model 'ClawerAnalysis'
        db.delete_table('clawer_claweranalysis')

        # Deleting model 'ClawerAnalysisLog'
        db.delete_table('clawer_claweranalysislog')
