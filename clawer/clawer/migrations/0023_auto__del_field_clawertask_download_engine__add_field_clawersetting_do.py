...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClawerTask.download_engine'
        db.delete_column('clawer_clawertask', 'download_engine')

        # Adding field 'ClawerSetting.download_engine'
        db.add_column('clawer_clawersetting', 'download_engine',
                      self.gf('django.db.models.fields.CharField')(default='requests', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ClawerTask.download_engine'
        db.add_column('clawer_clawertask', 'download_engine',
                      self.gf('django.db.models.fields.CharField')(default='requests', max_length=16),
                      keep_default=False)

        # Deleting field 'ClawerSetting.download_engine'
        db.delete_column('clawer_clawersetting', 'download_engine')
