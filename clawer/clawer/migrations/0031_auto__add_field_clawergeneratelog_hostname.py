...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClawerGenerateLog.hostname'
        db.add_column('clawer_clawergeneratelog', 'hostname',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClawerGenerateLog.hostname'
        db.delete_column('clawer_clawergeneratelog', 'hostname')
