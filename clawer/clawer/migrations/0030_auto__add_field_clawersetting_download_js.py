...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClawerSetting.download_js'
        db.add_column('clawer_clawersetting', 'download_js',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClawerSetting.download_js'
        db.delete_column('clawer_clawersetting', 'download_js')
