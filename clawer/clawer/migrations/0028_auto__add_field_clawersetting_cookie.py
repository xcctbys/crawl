...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClawerSetting.cookie'
        db.add_column('clawer_clawersetting', 'cookie',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClawerSetting.cookie'
        db.delete_column('clawer_clawersetting', 'cookie')
