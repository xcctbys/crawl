...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClawerDayMonitor'
        db.create_table('clawer_clawerdaymonitor', (
            ...
            ('is_exception', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('add_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('clawer', ['ClawerDayMonitor'])


    def backwards(self, orm):
        # Deleting model 'ClawerDayMonitor'
        db.delete_table('clawer_clawerdaymonitor')
    ...
    models = {
        ...
        'clawer.clawerdaymonitor': {
            'Meta': {'ordering': "['-id']", 'object_name': 'ClawerDayMonitor'},
            'add_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
