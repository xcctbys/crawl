...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClawerAnalysisLog.failed_reason'
        db.add_column('clawer_claweranalysislog', 'failed_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClawerAnalysisLog.failed_reason'
        db.delete_column('clawer_claweranalysislog', 'failed_reason')
