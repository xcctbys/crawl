...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClawerSetting.analysis'
        db.add_column('clawer_clawersetting', 'analysis',
                      self.gf('django.db.models.fields.IntegerField')(default=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClawerSetting.analysis'
        db.delete_column('clawer_clawersetting', 'analysis')
