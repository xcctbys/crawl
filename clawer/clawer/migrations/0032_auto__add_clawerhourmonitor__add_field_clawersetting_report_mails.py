...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClawerHourMonitor'
        db.create_table('clawer_clawerhourmonitor', (
        ...
        db.send_create_signal('clawer', ['ClawerHourMonitor'])

        # Adding field 'ClawerSetting.report_mails'
        db.add_column('clawer_clawersetting', 'report_mails',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ClawerHourMonitor'
        db.delete_table('clawer_clawerhourmonitor')

        # Deleting field 'ClawerSetting.report_mails'
        db.delete_column('clawer_clawersetting', 'report_mails')
