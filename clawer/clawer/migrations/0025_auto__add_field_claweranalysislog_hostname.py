...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClawerAnalysisLog.hostname'
        db.add_column('clawer_claweranalysislog', 'hostname',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClawerAnalysisLog.hostname'
        db.delete_column('clawer_claweranalysislog', 'hostname')
