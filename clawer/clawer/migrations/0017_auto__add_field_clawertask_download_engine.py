...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('clawer_clawertask', 'download_engine',
                      self.gf('django.db.models.fields.CharField')(default='requests', max_length=32),
                      keep_default=False)
    ...
    models = {
        ...
        'clawer.clawertask': {
            ...
            'cookie': ('django.db.models.fields.CharField', [], {'max_length': '4096', 'null': 'True', 'blank': 'True'}),
            'done_datetime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'download_engine': ('django.db.models.fields.CharField', [], {'default': "'requests'", 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
