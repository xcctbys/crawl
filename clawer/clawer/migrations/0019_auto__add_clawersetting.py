...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClawerSetting'
        db.create_table('clawer_clawersetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('clawer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clawer.Clawer'])),
            ('dispatch', self.gf('django.db.models.fields.IntegerField')(default=100)),
            ('last_update_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('add_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('clawer', ['ClawerSetting'])


    def backwards(self, orm):
        # Deleting model 'ClawerSetting'
        db.delete_table('clawer_clawersetting')
    ...
    models = {
        ...
        'clawer.clawertask': {
            ...
            'failed_reason': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
