...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClawerTask.task_generator'
        db.alter_column('clawer_clawertask', 'task_generator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clawer.ClawerTaskGenerator'], null=True))

    def backwards(self, orm):

        # Changing field 'ClawerTask.task_generator'
        db.alter_column('clawer_clawertask', 'task_generator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['clawer.ClawerTaskGenerator']))
