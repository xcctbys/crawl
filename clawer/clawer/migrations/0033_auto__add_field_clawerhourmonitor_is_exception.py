...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClawerHourMonitor.is_exception'
        db.add_column('clawer_clawerhourmonitor', 'is_exception',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClawerHourMonitor.is_exception'
        db.delete_column('clawer_clawerhourmonitor', 'is_exception')
