    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_date', models.DateField(verbose_name=datetime.datetime(2016, 5, 24, 12, 6, 39, 146955))),
            ],
            options={
                'db_table': 'parser',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_date', models.DateField(verbose_name=datetime.datetime(2016, 5, 24, 12, 6, 39, 148057))),
