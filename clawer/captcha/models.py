...
class Category(models.Model):
    ...
    full_choices = (
        ...
        (SICHUAN, u"四川", 'http://gsxt.scaic.gov.cn/ztxy.do?method=createYzm&dt=1449473634428&random=1449473634428',
         300),
        (GUIZHOU, u"贵州", 'http://gsxt.gzgs.gov.cn/search!generateCode.shtml?validTag=searchImageCode&1449473693892',
         300),
        ...
        (XINJIANG, u"新疆",
         'http://gsxt.xjaic.gov.cn:7001/ztxy.do?method=createYzm&dt=1449473880582&random=1449473880582', 300),
